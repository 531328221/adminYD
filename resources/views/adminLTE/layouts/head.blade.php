...
<link rel="stylesheet" href="{{ asset('themes/admin_lte/bower_components/jvectormap/jquery-jvectormap.css') }}">
<!--Theme style -->
<link rel="stylesheet" href="{{ asset('themes/admin_lte/css/AdminLTE.css') }}">
<link rel="stylesheet" href="{{ asset('themes/admin_lte/css/skins/_all-skins.min.css') }}">
<!-- iCheck -->
